...
Link to my dashboard: [E-Commerce Dashboard](https://bit.ly/ecommerce-dashboard)
...
## Data Publishing
The data was published from the PowerBI environment and a linkn was generated for others to view and interact with the dashboard.
Link to my dashboard:<a href="https://bit.ly/eccomerce-dashboard>ecommerce dashboard</a>
